# agent-infra-macro-edge-builder-ml-ldk

## Detailed Description

agent-infra-macro-edge-builder-ml-ldk is a iot-focused project that evaluates device telemetry and operational anomalies to improve fleet reliability and safety.  
